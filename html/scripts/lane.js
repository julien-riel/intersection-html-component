...
class Lane {
    ...
    drawLines() {
        ...
        if (this.lines.lineLeft) {
            if (this.lines.lineLeft.type == "solid") {
                draw.createLignePleine(margin + this.x, this.y + this.distanceLigneArret, margin + this.x, this.y + this.height, this.lines.lineLeft.color);
            }
            else {
                draw.createLignePointille(margin + this.x, this.y + this.distanceLigneArret, margin + this.x, this.y + this.height, this.lines.lineLeft.color);
            }
        }
        if (this.lines.lineCenter) {
            if (this.lines.lineCenter.type == "solid") {
                draw.createLignePleine(this.width + this.x, this.y + this.distanceLigneArret, this.width + this.x, this.y + this.height, this.lines.lineCenter.color);
            }
            else {
                draw.createLignePointille(this.width + this.x, this.y + this.distanceLigneArret, this.width + this.x, this.y + this.height, this.lines.lineCenter.color);
            }
        }
        if (this.lines.lineRight) {
            if (this.lines.lineRight.type == "solid") {
                draw.createLignePleine(-margin + this.width + this.x, this.y + this.distanceLigneArret, -margin + this.width + this.x, this.y + this.height, this.lines.lineRight.color);
            }
            else {
                draw.createLignePointille(-margin + this.width + this.x, this.y + this.distanceLigneArret, -margin + this.width + this.x, this.y + this.height, this.lines.lineRight.color);
            }
        }
        if (this.usage == "car" && this.type === "entrant")
            draw.createLignePleine(this.x, this.y + this.distanceLigneArret, this.x + this.width, this.y + this.distanceLigneArret, "white");
    }
    ...
    draw() {
        ...
        */
        draw.drawRectangle(this.x, this.y, this.width, this.height, this.getCouleurByUsage(this.usage));
